...
function calcularPenalizacaoHibrida(diasNaoUteis: number): number {
...
function calcularEficienciaHibrida(
  diasUteis: number, 
  diasNaoUteis: number, 
  feriadosEmDiasUteis: number = 0,
  valorEstrategico: number = 0,
  valorAtivacaoFimDeSemana: number = 0
): number {
...
function classificarEficiencia(eficiencia: number): string {
...
function formatarEficiencia(eficiencia: number): string {
...
function executarTestes(): void {
  ...
  function calcularPenalizacaoLinear(diasNaoUteis: number): number {
