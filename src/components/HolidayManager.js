...
const HolidayManager = ({ onHolidaysUpdated }) => {
          ...
          <div className="bg-white p-4 rounded shadow-sm">
            <div className="flex flex-wrap gap-3 mb-4">
              <div className="flex-1">
                ...
                <select id="yearFilter" value={yearFilter} onChange={(e) => setYearFilter(Number(e.target.value))} className="w-full px-3 py-2 border rounded">
              ...
              <div className="flex-1">
                ...
                <select id="typeFilter" value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} className="w-full px-3 py-2 border rounded">
              ...
              <div className="flex-1">
                ...
                <input id="searchText" type="text" value={searchText} onChange={(e) => setSearchText(e.target.value)} placeholder="Nome do feriado" className="w-full px-3 py-2 border rounded"/>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                ...
                <tbody>
                  {filteredHolidays.length > 0 ? (filteredHolidays.map((holiday, index) => (<tr key={`${holiday.date}-${index}`} className="border-b">
