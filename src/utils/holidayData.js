...
export const generateRecessPeriods = (startYear, endYear) => {
    const recessPeriods = [];
...
export const recessPeriods = generateRecessPeriods(2024, 2027);
...
export const getAllHolidays = () => {
    ...
    const municipalHolidays = custom.filter(h => h.abrangencia && h.abrangencia.toLowerCase().includes('municipal'));
...
export const updateCustomHolidays = (holidays) => {
    ...
    const municipalHolidays = holidays.filter(h => h.abrangencia && h.abrangencia.toLowerCase().includes('municipal'));
    ...
    if (municipalHolidays.length > 0) {
        ...
        customHolidays = customHolidays.filter(h => !h.abrangencia || !h.abrangencia.toLowerCase().includes('municipal'));
...
export const addCustomHoliday = (holiday) => {
