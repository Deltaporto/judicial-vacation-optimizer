 ...
 */
export const municipalHolidayTemplates: Record<string, {date: string, name: string}[]> = {
  'Rio de Janeiro': [
 ...
 */
export const specificEvents: Record<string, {date: string, name: string}[]> = {
  'São Gonçalo': [
 ...
 */
export function getAllMunicipalHolidays(year: number): Holiday[] {
