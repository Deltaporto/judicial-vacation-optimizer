...
const analyzeVacationPeriod = (period) => {
...
const calculateTheoreticalMaximum = (totalDays) => {
...
const findOptimalFiveDayPeriods = (year) => {
...
const selectBestNonOverlappingPeriods = (sortedPeriods, count) => {
    const selected = [];
